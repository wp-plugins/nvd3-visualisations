...
$shortcodes = "[loadNVD3] <br /> [jsChart type='".$ctype."' datafile='".$owndata."' height=250  width=450 float='none' border='3px outset gray' backgroundcolor='darkgray' options='{showLegend: true, tooltips: true, showControls: true, noPopup: false, noResize: false}' ] ";
