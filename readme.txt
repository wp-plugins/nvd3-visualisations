...
Look at the blog's root and the folder called "charts_nvd3". Data sets are stored there by random names and they stay there until you remove them by FTP client. If you create very many/big data sets it is a good idea to clean this folder from time to time manually.
